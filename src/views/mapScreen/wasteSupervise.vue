<template>
  <div class="park-overview">
    <v-map ref="mapContent" id="mapContent" :class="{'map-index': mapIndex}" @reload="changeFullWindowVisible" @companyData="childCompanyData" @hrefVideo="hrefVideoP"></v-map>
    <div class="header">
      <div class="charts-title">南平市危废智能监管平台</div>
      <!--<div class="charts-title">**市危废智能监管平台</div>-->
    </div>
    ...
    <!--向右按钮-->
    <transition name="turn-opacity-left-btn">
      <div class="search-item" v-if="!leftShow">
        <el-input placeholder="请输入要查询的企业名称" v-model="searchItemKey" class="input-with-select" clearable>
          <template slot="prepend"><div @click="turnRight"><span class="icon iconfont iconindent-increase"></span>产废动态</div></template>
          <el-button slot="append" icon="el-icon-search" @click="getCompanyPositionType('all')"></el-button>
        </el-input>
      </div>
    ...
    <div class="map-center-content">
      <v-map-center-content @companyData="childCompanyData"></v-map-center-content>
    </div>
    ...
    <!--向左按钮-->
    <transition name="turn-opacity-right-btn">
      <div class="search-item search-item-right" v-if="!rightShow">
        <div @click="turnLeft" class="search-item-text"><span class="icon iconfont iconindent-decrease"></span>全市统计</div>
      </div>
    ...
    <transition name="el-fade-in-linear">
      <v-common-table-info ref="vCommonTable" v-if="commonWindowVisible" @reload="changeCommonVisible" @changePositionCenter="getWeightPosition"></v-common-table-info>
    </transition>
    <!--fullWindow弹出层-->
    <transition name="el-fade-in-linear">
...
import MapCenterContent from '@/components/map/mapCenterContent'
...
export default {
  ...
  components: {
    ...
    'v-map-center-content': MapCenterContent,
  ...
  methods: {
    ...
    getCompanyPositionType (type) {
      this.$refs.mapContent.getCompanyPosition(type, this.searchItemKey)
    },
    setToken () {
