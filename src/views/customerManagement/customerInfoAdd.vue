<template>
  <div class="customer-manage bussiness-info">
    ...
    <el-tabs v-model="activeName" type="card" :before-leave="beforeClick">
      ...
      <el-tab-pane label="联系人" name="contactsInfo" :lazy="true">
        <v-contacts-info></v-contacts-info>
      </el-tab-pane>
      ...
      <el-tab-pane label="附件预览" name="financialInfo" :lazy="true">
        <v-financial-information></v-financial-information>
      </el-tab-pane>
    </el-tabs>
  </div>
...
import CompanyInfo from '@/views/customerManagement/components/companyInfo'
import WasteInfo from '@/views/customerManagement/components/wasteInfo'
import ContactsInfo from '@/views/customerManagement/components/contactsInfo'
import FinancialInformation from '@/views/customerManagement/components/financialInformation'
