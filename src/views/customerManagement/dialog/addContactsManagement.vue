...
import { getCodeAndNameDic, getClassCode, getWasteCode, addContacts, editContacts } from '@/assets/js/API/api'
export default {
  name: 'addWaste',
  data () {
    ...
    submitDialog (formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          } else if (_this.addCheckObj.type === 'add') {
            addContacts(postData)
              .then(res => {
