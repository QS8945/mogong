                  ...
                  <el-row style="margin-top:20px;" :gutter="100">
                     <el-col :span="24">
                       <el-form-item label="八位码：" prop="matCode">
                         <el-input v-model="addForm.matCode" clearable @keyup.enter.native="queryData" placeholder="请输入八位码" >
                  ...
                  <el-row style="margin-top:20px;" :gutter="100">
                    <el-col :span="24">
                      <el-form-item label="危废俗称">
                         <el-input clearable @keyup.enter.native="queryData" v-model="addForm.matName" placeholder="请输入危废俗称"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="100">
    ...
    methods: {
      ...
      autoData() {
        ...
        if (vm.addForm.compQuantity && vm.addForm.compQuantity != '') {
          ...
          vm.checkObjP = {
            ...
            isExistManualResult: vm.bottomRecords && vm.bottomRecords.length > 0 ? true : false
          }
      ...
      getData() {
        ...
        let postData = {
          ...
          matCode:_this.addForm.matCode,
          matName:_this.addForm.matName,
      ...
      chooseMatcode(row){
        ...
        _this.addForm.matCode=row.wasteCode;
        _this.addForm.matName=row.entWasteName;
