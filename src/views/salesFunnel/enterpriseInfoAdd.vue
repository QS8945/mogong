<template>
  <div class="customer-manage bussiness-info">
    ...
    <el-tabs v-model="activeName" type="card" :before-leave="beforeClick">
      <el-tab-pane label="客户信息" name="companyInfo">
        <v-company-info></v-company-info>
      </el-tab-pane>
      <el-tab-pane label="客户的危废" name="wasteInfo" :lazy="true">
        <v-waste-info></v-waste-info>
      </el-tab-pane>
      <el-tab-pane label="客户的财务" name="financialInfo" :lazy="true">
        <v-financial-information></v-financial-information>
      </el-tab-pane>
      <el-tab-pane label="附件预览" name="attachInfo" :lazy="true">
        <v-attach-info :sourceId="$route.query.data"></v-attach-info>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
...
<script>
  ...
  import CompanyInfo from '@/views/salesFunnel/components/companyInfo'
  import WasteInfo from '@/views/salesFunnel/components/wasteInfo'
  import AttachInfo from '@/views/salesFunnel/components/attachInfo'
  import FinancialInformation from '@/views/salesFunnel/components/financialInformation'
  import {
    saveEnterpriseAndEnterpriseDetail,
    getEnterpriseAndEnterpriseDetail,
    modifyEnterpriseAndEnterpriseDetail,
    getSysCanton,
  ...
  export default {
    ...
    components: {
      ...
      'v-attach-info': AttachInfo,
      'v-financial-information': FinancialInformation
    },
    methods: {
      getData() {
        let _this = this
