...
import AddLandfillOperatingAccount from '@/views/landfillManagement2.0/dialog/addLandfillOperatingAccount'
import AddLandfillWaste from '@/views/landfillManagement2.0/dialog/addLandfillWaste'
...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      getFillbusinessParameterList(postData, params)
        .then(res => {
          res.data.tableHead = [{
            'value': 'fillDate',
            'name': '填埋日期',
    ...
    delSection (obj) {
      ...
      this.$confirm('确认删除？', '提示', {
        ...
        deleteFillbusiness(postData, params).then(res => {
