...
import AddLandfillsBasicInfo from '@/views/landfillManagement2.0/dialog/addLandfillsBasicInfo'
...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      getFillBaseinfoListPage(postData, params)
        .then(res => {
    ...
    delSection (obj) {
      ...
      this.$confirm('确认删除？', '提示', {
        ...
        deleteFillBaseinfo(postData, params).then(res => {
    ...
    load (tree, treeNode, resolve) {
      ...
      getFillBaseinfoListPage(postData, params).then(res => {
