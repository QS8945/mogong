  ...
  <div class="view-total baseForm">
    <div class="table-form">
      <el-form :inline="true" :model="queryForm" class="demo-form-inline" :label-position="'right'">
        ...
        <el-form-item label="产废单位：" v-if="!$route.query.cusId||$route.query.cusId==''">
        ...
        <el-form-item label=" ">
          ...
          <el-button v-if="$route.query&&$route.query.cusId&&$route.query.cusId!=''" class="back-to-customer" type="text" @click="backToSalesFunnel"
            plain>
